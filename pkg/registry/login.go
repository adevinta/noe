...
import (
	...
	"github.mpi-internal.com/schip/toolkit/log"
...
func (r RegistryAuthenticator) getHeaderOnContainerdFiles(repository string) (ContainerdServerHeader, error) {
	...
	err := afero.Walk(system.DefaultFileSystem, directory, func(path string, info os.FileInfo, err error) error {
		if err != nil {
			return nil
		}
		...
		configData, err := afero.ReadFile(system.DefaultFileSystem, path)
		if err != nil {
			return nil
		}
